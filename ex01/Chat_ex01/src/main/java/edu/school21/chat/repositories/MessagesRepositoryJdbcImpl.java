...
public class MessagesRepositoryJdbcImpl implements MessagesRepository {
	...
	public Optional<Message> findById(Long messageId) throws SQLException {
		...
		try {
			...
			optionalMessage = Optional.of(new Message(messageId, getMessageAuthor(connection, resultSet.getLong(2)),
					getMessageChatRoom(connection, resultSet.getLong(3)), "0", resultSet.getString(4)));
